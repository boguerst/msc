...
DiagramComponent.ɵfac = function DiagramComponent_Factory(t) { return new (t || DiagramComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.KeyValueDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DiagramComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.KeyValueDiffers }, { type: ɵngcc0.NgZone }]; }, { linkDataArray: [{
            type: Input
        }], modelData: [{
            type: Input
        }], skipsDiagramUpdate: [{
...
PaletteComponent.ɵfac = function PaletteComponent_Factory(t) { return new (t || PaletteComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.KeyValueDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
PaletteComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PaletteComponent, selectors: [["gojs-palette"]], viewQuery: function PaletteComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { linkDataArray: "linkDataArray", modelData: "modelData", skipsPaletteUpdate: "skipsPaletteUpdate", initPalette: "initPalette", nodeDataArray: "nodeDataArray", divClassName: "divClassName" }, outputs: { modelChange: "modelChange" }, decls: 2, vars: 1, consts: [[3, "className"], ["ngPalette", ""]], template: function PaletteComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", 0, 1);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("className", ctx.divClassName);
    } }, encapsulation: 2 });
...
DataSyncService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DataSyncService, factory: DataSyncService.ɵfac });
/** @nocollapse */
...
GojsAngularModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function GojsAngularModule_Factory(t) { return new (t || GojsAngularModule)(); }, providers: [
        DataSyncService
    ], imports: [[]] });
